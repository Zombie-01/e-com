  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">Гарчиг</h1>
          <p className="text-gray-600">Дэд гарчиг</p>
        </div>
        <Button onClick={() => setShowModal(true)}>
          <Plus className="w-4 h-4 mr-2" /> Бүтээгдэхүүн нэмэх
        </Button>
      </div>
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="max-h-[70vh] overflow-auto">
          <DialogHeader>
            <DialogTitle>
              {editingProduct
                ? "dialog.editProductTitle"
                : "dialog.createProductTitle"}
            </DialogTitle>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <Input
                ...
                placeholder="dialog.englishName"
                required
              />
              <Input
                name="mnName"
                value={form.mnName}
                onChange={handleFormChange}
                placeholder="dialog.mongolianName"
                required
              />
              <Input
                name="sku"
              ...
              <select
                ...
                required>
                <option value="">dialog.selectBrand</option>
                {brands.map((b) => (
              ...
              <select
                ...
                className="border p-2 rounded"
                required>
                <option value="">dialog.selectCategory</option>
                {categories.map((c) => (
              ...
              <textarea
                ...
                value={form.enDesc}
                onChange={handleFormChange}
                placeholder="dialog.englishDescription"
              ...
              <textarea
                ...
                value={form.mnDesc}
                onChange={handleFormChange}
                placeholder="dialog.mongolianDescription"
                className="border p-2 col-span-2"
                required
              />
            </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>table.salePercent</TableHead>
      ...
      <Dialog
        ...
        <DialogContent>
          ...
          {previewProduct && (
            <div className="space-y-4">
              <p>
                <strong>preview.name:</strong> {previewProduct.enName}
              </p>
              <p>
              ...
              <p>
                <strong>preview.variants :</strong>
              </p>
