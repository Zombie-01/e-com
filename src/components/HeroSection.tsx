    ...
    return (
      <section className="relative h-[600px] bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-xl">Discover luxury products crafted for modern living</p>
        </div>
      </section>
    )
  }
  ...
  return (
    <section className="relative h-[600px] overflow-hidden">
      <div className="relative w-full h-full">
        <Image
          src={currentBanner.image || 'https://images.pexels.com/photos/934063/pexels-photo-934063.jpeg'}
