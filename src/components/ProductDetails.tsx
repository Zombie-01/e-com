...
export default function ProductDetails({ product, locale }: ProductDetailsProps) {
  ...
  const availableSizes = [...new Set(product.variants.filter((v: any) => 
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-4">
        <div className="relative aspect-square overflow-hidden rounded-2xl bg-gray-100">
          <Image
            src={selectedColor?.image || 'https://images.pexels.com/photos/934070/pexels-photo-934070.jpeg'}
            ...
            {availableColors.map((color: any) => (
              <button
                ...
                className={`relative aspect-square rounded-lg overflow-hidden border-2 ${
                  selectedColor?.id === color.id ? 'border-blue-500' : 'border-gray-200'
                }`}
              >
                <Image
                  src={color.image}
